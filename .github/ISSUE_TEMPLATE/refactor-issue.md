...
<!-- Problema estrutural atual e por que ele importa, com evidência. -->

## Escopo

- <!-- Resultado estrutural ou limite de ownership desejado -->
- <!-- Contrato interno, compatibilidade, migração ou restrição arquitetural -->
- **Preservar:** <!-- Comportamento observável e contratos externos -->
- **Não incluído:** <!-- Comportamento adjacente ou cleanup excluído -->
