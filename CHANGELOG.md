...
* 📚 docs: remove backlog item issue template and update bug issue template for clarity; add new feature issue template (aba51555c)
* 🔀 merge: pull request #548 (14475bdaa)
* 📚 docs: update AGENTS.md and SDD documentation for clarity and consistency. (281eed5f5)
* 🔀 merge: pull request #571 (962f055ed)
* 🔀 merge: pull request #570 (ee3965b82)
* 🔀 merge: pull request #558 (01eed7857)
* 📦 deps: bump immer from 10.2.0 to 11.1.18 (859718baf)
* 📦 deps: bump vite from 7.0.0 to 8.2.1 (#540) (4f7964745)
* 📦 deps: bump @ai-sdk/google from 3.0.88 to 4.0.44 (#541) (e317caec0)
* 📦 deps: bump tailwind-variants from 0.3.1 to 3.3.1 (#542) (bbf9cf29f)
* 📚 docs: add mandatory persistence guidelines for Orchestrator updates in implementation prompts (27e62a3be)
* 🔀 merge: pull request #538 (fe64415f2)
* 🧪 test(web): cover protected route entry flows (35eeac0ea)
* 🐛 fix(web): isolate challenge category data in tests (de48cb6db)
* 🧪 test(web): stabilize route integration coverage (c06861d01)
* 🔧 build: synchronize npm lockfile (f9d5ea049)
* 🧪 test(web): expand route integration coverage (be916d0b6)
* 🧪 test(web): cover rewarding page compositions (2e5483d42)
* 🔀 merge: pull request #537 (715ac52a2)
* 📚 docs: update AGENTS.md to include `browser-use` for interactive browser tasks and clarify its role alongside Playwright (87238a2b3)
* 📚 docs: add local development and credential guidelines to AGENTS.md (d01eb0ab5)
* 📦 deps: bump apexcharts from 4.7.0 to 6.7.0 (#533) (b93dbc922)
* 📦 deps: bump @hono/node-server from 1.19.14 to 2.1.0 (#534) (d42d95cfe)
* 📦 deps: bump cross-env from 7.0.3 to 10.1.0 (#532) (d63021aa3)
* 📦 deps: bump supabase/postgres from 15.8.1.085 to 17.6.1.160 (#536) (8773eff79)
* 📦 deps: bump the docker-compose-minor-and-patch group with 2 updates (#535) (70be5fc02)
* 📦 deps: bump @babel/preset-react from 7.28.5 to 8.0.1 (#531) (cc9c96a42)
* 📦 deps: bump the npm-minor-and-patch group with 27 updates (#530) (01d93e707)
* 🔀 merge: pull request #529 (d231d8d7a)
* 🐛 fix(server): bundle email templates in server build (46830574d)
* 🔀 merge: pull request #528 (883190c81)

## 1.8.0 (2026-08-03)

* 🎨 design: update playback generation panel and input field styles (cee67f3c5)
* 🔀 merge: pull request #520 (4acc59004)
* 📚 docs(web): close edition protection specification (aa8598e61)
* 🧪 test(web): synchronize official solution navigation assertion (a1d051589)
* ⚙️ config: configure isolated Playwright test environment (b2d8cad49)
* 📚 docs: document plan judging and editor protection (3ffbf4488)
* ⚙️ config: add local integration test server (9347ad60c)
* 🧪 test: cover unsaved editor navigation protection (b2464e688)
* 🖥️ ui: protect unsaved editor navigation (41ea4c59f)
* ⚙️ config: ignore local PRD directory (dd8b88b12)
* 📦 deps: lock impeccable skill metadata (67a7c7685)
* ⚙️ config: add local E2E environment loaders (dc5f69e94)
* 🎨 design: update Stardust product screens (0945fec1a)
* 📚 docs: update challenge and feedback report PRDs (3a1b76fb3)
* 📚 docs: update product and issue workflow prompts (42aaf656b)
* 📚 docs: align SDD workflow guidance (bb2ac2ff5)
* 📚 docs: document challenge editor requirements (66dddf944)
* 🎨 design: update Stardust design file (d6ecacdea)
* 🐛 fix(studio): validate environment before startup (4938a6e63)
* 🐛 fix(studio): fix type in envs (6c6a2957d)
* 📚 docs: update Changelog to version 1.8.0 (424d966aa)
* 🔀 merge: #515 (a5777f82b)
* 📚 docs: add playright guidelines to AGENTS.md (b984c591b)
* 📦 deps: bump the docker-compose-minor-and-patch group across 1 directory with 4 updates (#511) (d3443e3bb)
* 📦 deps: bump @react-router/dev from 7.18.1 to 8.3.0 (#505) (0f614a592)
* 📦 deps: bump inngest from 3.19.4 to 4.13.0 (#508) (5213c2c9b)
* 📦 deps: bump vite-tsconfig-paths from 5.1.4 to 6.1.1 (#507) (a15c595b3)
* 📦 deps: bump markdown-to-jsx from 7.7.17 to 9.9.0 (#506) (29996e9b1)
* 📦 deps: bump the npm-minor-and-patch group across 1 directory with 74 updates (#504) (0eab728c8)
* 📦 deps: bump supabase/setup-cli from 1 to 3 (42cfb0503)
* 📦 deps: bump actions/checkout from 4 to 7 (327889fca)
* 📚 docs: remove obsolete dead-code sensor (50cbbe9f0)
* 🧪 test(web): cover invalid sessions on public routes (0e0d78e6d)
* 🐛 fix(web): recover invalid sessions on public routes (c1bc3604a)
* 🧪 test(server): cover development notification suppression (660711234)
* 🐛 fix(server): suppress development Discord notifications (4416e8fa7)
* ⚙️ config: align workspace package metadata (0ae999740)
* 📦 deps: remove obsolete dead-code tooling (dccbb98e0)
* 🔀 merge: pull request #512 (b5dca2279)
* 🐛 fix(studio): provide CI build environment (18b0bd6f2)
* ⚙️ config: temporarily disable dead code quality gate (4167ef869)
* 📚 docs: close assistant history pagination spec (ca9aa8913)
* 🐛 fix(web): preserve assistant history pagination (dbce4431f)
* 📚 docs(web): document assistant history pagination fix (51fb35fff)
* 📚 docs: migrate harness workflow documentation (53b199a8e)
* 🏎️ ci: replace harness workflows with quality gate (486e85b56)
* ⚙️ config: standardize workspace checks (5e777c254)
* ♻️ refactor: delete harness package (c786b5b1c)
* 🗃️ ftree: remove stardust.wiki subproject reference (a12efe2fb)
* 🐳 docker: remove Supabase services and related configurations from docker-compose.yml (ceea5283b)
* 📦 deps: update dependencies in package.json and package-lock.json, adding dependency-cruiser and knip (df4b0f166)
* 📚 docs: update official solution plan and specification status to in_progress (0c159a046)
* 🐛 fix: align gate runners, migrations, and globs (b57193df9)
* 🔀 merge: pull request #510 (303f6802b)
* 📚 docs: close official solution conclusion (0a791f923)
* 🏎️ ci: build lsp before server tests (c0e146f2c)
* 📚 docs: finalize quality ratchet conclusion (43dba5056)
* 🏎️ ci: build lsp before quality ratchets (4738acf91)
* 📚 docs: finalize official solution conclusion (5f28d0364)
* 🐛 fix(web): stabilize challenge page cleanup and ci (10c07afc0)
* 📚 docs: close official solution specification (20b8edbbd)
* ⚙️ config: finalize quality gates (9a5233a20)
* 🖥️ ui(web): complete official solution flow (62391c5cf)
* 📶 rest(server): complete official solution transport (0b9384494)
* 📚 docs: document harness workflow and official solution (7a0c100ca)
* ⚙️ config: migrate quality checks to harness (aff87a440)
* 🐛 fix(web): stabilize challenge test execution (867a0c887)
* 💾 db(server): persist official solution playback (e03fbffad)
* 🌐 domain(core): add official solution playback contract (fbf39e9ad)
* ♻️ refactor(server): add missing newline for improved code readability (1e22f73bd)
* 📚 docs: add official solution specification with links to PR and issue (3b060cdcb)
* 🚚 cd: update deployment workflows to enable concurrent job cancellation and simplify curl commands for Coolify integration (5f7f95835)
* 🐳 docker(server): add LSP package dependencies to Dockerfile for improved functionality (19d44561d)
* 🚚 cd: streamline Coolify deployment workflows by removing unused steps and enabling concurrent job cancellation (6e80c7fb0)
* ♻️ refactor(server): remove unnecessary blank line for cleaner code (369edcdb1)
* 🚚 cd: enhance curl command in deployment workflows with timeout and retry options (7186b68b7)
* 🔀 merge: pull request #501 (3462666b7)
* 🔀 merge: pull request #500 (8500fc623)
* 🔀 merge: pull request #498 (9a2cec23c)
* 🔀 merge: pull request #497 (247266dda)
* 🔀 merge: pull request #494 (517e840d8)
* 🔀 merge: Pull Resquest #489 (ad1a66738)
* 🐳 docker(studio): update turbo to version 2.10.2 for improved performance (a25382df8)
* ⚙️ config(studio): add aliases for buffer and process in Vite configuration and simplify node polyfills inclusion (5418d1fd7)
...
* ♻️ refactor: delete unused space-authenticated.png file from the repository (c601a595a)
* 📚 docs: add bug report for internal error due to undefined initial code in challenge page (08738d5a6)
* ♻️ refactor: add console log for codeValue in getFunctionName method of DeleguaProvedorLsp class (55ba5b03f)
* ⚙️ config: add "dom" library to TypeScript configuration for LSP package (75b59cf43)
* 🧪 test(server): rename test utility functions for clarity and consistency in SupabaseAuthService tests (41514c4bb)
* 🧪 test(server): add unit tests for HonoApp to verify Inngest signing key handling in production mode (99b75d203)
* 🧪 test(server): implement SupabaseAuthService tests for account retrieval logic and add ListResponse type import (b5dff2fe1)
* ⚙️ config: update Inngest configuration to conditionally include signingKey and eventKey based on environment mode (950e58896)
* ♻️ refactor: comment out eventKey in Inngest configuration for development mode (39a711efc)
* 🐳 docker: update .dockerignore to include additional patterns for build artifacts, coverage, and environment files (677ea0e73)
* 📶 rest: add liveness endpoint to HonoApp for service health checks (0898ded1c)
* 📶 rest: add isDev flag to health check response for development mode (a9d9408ad)
* 📶 rest: add eventKey and signingKey to health check response for production mode (cbcc70a73)
* 🔀 merge: pull request #482 (3fd07a22a)
* 📦 deps: bump inngest/inngest in the docker-compose-minor-and-patch group (#479) (b1645e4c8)
* 📦 deps: bump @faker-js/faker from 8.4.1 to 10.5.0 (#478) (7aa5ad91c)
* 📦 deps: bump jest-environment-jsdom from 29.7.0 to 30.4.1 (#477) (bacabc456)
* 📦 deps: bump react-easy-crop from 5.5.6 to 6.2.2 (#476) (5438f8b2a)
* 📦 deps: bump jest-environment-node from 29.7.0 to 30.4.1 (#475) (e0c5a0149)
* 📦 deps: bump supabase/setup-cli from 2 to 3 (#473) (d4ca8e08e)
* 🧰 prov: split S3 storage file helpers (f270cf9dd)
* 🏎️ ci: update storage environment variables (dcc11a063)
* 🐳 docker: update .dockerignore to include .env.example (967a16a9c)
* 📚 docs: update S3 storage environment references (f32a546b3)
* 🖥️ ui: switch signed storage clients to S3 (3573fabbe)
* 🧰 prov: migrate file storage to S3 (71304f10c)
* 📦 deps: add S3 SDK packages (58657a9d1)
* 🐛 fix: restore pr quality gates (6f2a94135)
* Ajuste da velocidade de coleta de cobertura do quality gate do server (#471) (21c0be610)
* ⚙️ config(server): integrate startNodeServer for server initialization (7b441f00f)
* ⚙️ config: update inngest service URL port in docker-compose.yml (06924d842)
* 🧪 test(server): implement startNodeServer function with port retry logic and add tests (eadac3ff4)
* 🐛 fix: stabilize storage backup pr ci (334d3d645)
* 🐛 fix: resolve storage backup pr checks (9e97e05da)
* 📚 docs: include pending commits in pr prompt (6581b9f48)
* 📚 docs: close backup spec and move plan (6eaf615c9)
* 🐛 fix(server): isolate file backup paths in dropbox (e1626a290)
* ✨ use case(core): exclude database backups from file backup (dd3328957)
* 🧪 test(core): refactor AudioVoice test cases for improved readability (fa4a71bc9)
* 🖥️ ui(web): update tailwind-scrollbar plugin syntax in global CSS (90f46e39a)
* 🖥️ ui(web): enhance WYSIWYG editor with markdown extension configuration (ef4331ec7)
* 💾 db: align supabase payload typings (cb9ebb43a)
* 📦 deps: bump actions/checkout from 4 to 7 (011959098)
* 🏎️ ci: strip supabase secret key quotes (ecc1004c7)
* 🏎️ ci: use supabase secret key in server tests (dd1335f5f)
* 🏎️ ci: run supabase status from server app (4e4fd4851)
* 🏎️ ci: use local supabase service role in server tests (59649a249)
* 🏎️ ci: inline fake test envs in workflows (e0d672592)
* 🏎️ ci: use versioned test envs in workflows (7ec05575d)
* 🧪 test(server): align inngest assembly expectations (c271a23bd)
* 🎨 design: update profile screen layout (f781c1d60)
* 📚 docs: align storage backup docs with dropbox only (e0c72f750)
* 🐛 fix: remove google drive from storage backups (77db8488d)
* ✨ use case: add storage files backup flow (0db499101)
* 📦 deps: bump @react-router/serve from 7.18.1 to 8.1.0 (c499d350d)
* 📦 deps: bump @ai-sdk/react from 3.0.221 to 4.0.17 (f44ebdeee)
* 📦 deps: bump supabase/setup-cli from 1 to 2 (14c9217b8)
* 📦 deps: bump actions/setup-node from 5 to 6 (3ecdd1cb5)
* 📦 deps: bump redis from 7-alpine to 8-alpine (00a4f07a5)
* 📦 deps: bump inngest/inngest in the docker-compose-minor-and-patch group (43c505041)
* 📚 docs: document agent workflow rules (b66367cdc)
* 🧪 test(server): cover comment and user absence controllers (9d376d19a)
* 🐛 fix(web): schedule wysiwyg content updates (9e87ae7c4)
* ♻️ refactor(server): remove unused imports (5ddcf8c99)
* ⚙️ config: ignore local mcp files (a381bd47e)
* 🐳 docker: run inngest locally with compose (86d5111b0)
* 🏎️ ci: run checks for dependency updates (11f0388db)
* 📚 docs: add specification for automatic file backup to Dropbox and Google Drive (471c2155b)
* ⚙️ config: configure dependabot (8cf243e50)
* 📚 docs: add star reward integrity specification to ensure server-side question count validation (d3d1d4d01)
* 📦 deps(server): remove unused AI SDK dependencies from server configuration (757fa9473)
* ⚙️ config: sync skills from prompt files (037734909)
* 📚 docs: add challenge result fix artifacts (44dcd9205)
* 🧰 provision: refine lsp translation contracts (9eff8b441)
* 🌐 domain: remove debug logging from code structure (7b8a4062c)
* 🐛 fix: log challenge runner internal errors (cd3f77645)
* 🖥️ ui: add public challenge result route (817cc6483)
* 🐛 fix: resolve PR quality gate regressions (def9744b5)
* 📚 docs: finalize embeddings removal spec docs (1f2c2a51f)
* 📦 deps: update package lock (64b924397)
* 🐛 fix: satisfy server quality gate (5362209b3)
* 📶 rest: remove embeddings search from storage services (47c8cdb4e)
* 📦 deps(server): remove embeddings packages from server (79434df9e)
* 🤖 ai: remove manual guide search tool (73341a5eb)
* ⚙️ config: update next type references (5e5bce1e1)
* 📟 rpc: update next cache revalidation (c938d713b)
* 🖥️ ui: adapt analytics and editor integrations (62c2c901d)
* ⚙️ config: align server jest runtime (0585af628)
* 🤖 ai: adapt mastra workflow result types (a6727c4f6)
* 🧰 prov: replace exceljs workbook generation (ac09bc724)
* ♻️ refactor: adapt inngest function registration (50c2650ab)
* 📦 deps: resolve vulnerable dependencies (677c8b969)
* 📚 docs: add commit rules for semantic versioning and message formatting (70b76aecb)
* ⚙️ config(server): restore default port 3333 (1e11c928b)
* 🐛 fix(server): resolve PR 449 quality gate and Inngest port (0382f8a19)
* 🎨 design: add authenticated space screenshot (269e495b5)
* 📚 docs: add space page scroll bug specification (367b6b55f)
* 🐛 fix: defer markdown sync in wysiwyg editor (b0b0ac204)
* 📚 docs: document direct spec flow and mcp usage (793feea5a)
* ⚙️ config: simplify server dev runtime and mcp ignores (19ca34d65)
* 🐛 fix(web): resolver pendencias do quality gate no drawer de notas (dd9c59b33)
* 🐛 fix(web): corrigir fechamento manual do drawer de notas (23b8763ba)
* 🐛 fix(web): resolver pendencias do quality gate da space page (2a93be324)
* 🐛 fix(web): corrigir centralizacao da ultima estrela desbloqueada (e13cdc557)
* 🐛 fix(web): resolver pendencias do quality gate no drawer de notas (6e74e853a)
* 🐛 fix(web): corrigir fechamento manual do drawer de notas (22f4c6d9f)
* 📚 docs: clarify bug report and server integration flows (66e1b9d84)
* 🐛 fix: harden server health checks and test bootstrap (20984a400)
* 🧪 test: update redis options coverage to use provider api (b2b04a6ce)
* ⚙️ config: bundle ai sdk dependencies in server build (aa07f4892)
* ♻️ refactor(server): move buildRedisOptions function into IORedisCacheProvider for better encapsulation (e2bb54054)
* 🐛 fix(server): introduce buildRedisOptions function for improved Redis configuration management (23768bce0)
* ♻️ refactor(server): improve code formatting in CheckHealthController and update test database URL for clarity (91a9dc6d0)
* 🐛 fix(server): enhance IORedisCacheProvider with improved connection handling and error logging (cb22952ec)
* 📚 docs: update resolve-pr-pendencies prompt with improved CI check guidance and operational principles (14130b727)
* ✅ test: cover health check dependencies (7867912fd)
* ⚙️ config: add merge-worktree script and enhance env file copying logic (59c5c3140)
* ♻️ refactor: improve readability of timeout setup in CheckHealthController and format database URL in tests (710b54f1f)
* ♻️ refactor: remove unnecessary newline in CheckHealthController (71be236ad)
* 📚 docs: remove project overview documentation for StarDust platform (c68fe618a)
* 🧪 test: add health endpoint coverage (25b009d30)
* 📶 rest: add health endpoint with service checks (a287062fe)
* ⚙️ config: scripts de gerenciamento de worktrees (6ca5df4b1)
* 🚚 cd: remove Discord notification steps from CI workflows for studio, web, and staging deployments (484a22dfd)
* 📦 deps(lsp): update @designliquido/delegua dependency to version 1.25.1 in package.json and package-lock.json (d939d02ee)
* 🚚 cd: remove Discord notification steps from CI workflows for studio, web, and staging deployments (28f06cc2e)
* 📚 docs: add project overview and module architecture documentation for StarDust platform (0f8296f5b)
* 📚 docs: add web integration tests plan for account confirmation (28156f678)
* ⚙️ config: update .gitignore to include *.tsbuildinfo files (5967661f8)
* 📚 docs: document quality gate PR comment (cfd22bafd)
* 🏎️ ci: comment quality gate report on PRs (bc7dc8f7d)
* ⚙️ config: emit quality gate report file and PR sticky-comment script (578841d5d)
* 🖥️ ui: treat retry conflict as success and refetch user (8e8f70f8c)
* 🏎️ ci: trigger workspace CIs on quality-gate script changes (e5b8dcfe9)
* ⚙️ config: add MCP config sync script for opencode and codex (34b56c3b5)
* 📚 docs: clarify post-change command as unit tests (f4496ceec)
* 🖥️ ui: set aria-describedby on dialog content for accessibility (b70ba7677)
* 📚 docs: document multi-workspace quality gate rollout (381e5bbab)
* 🏎️ ci: add quality-gate job to server, web and studio workflows (ffd6c8890)
* ⚙️ config: extend quality gate to server, web and studio workspaces (48b2b0938)
* 📚 docs: rename resolve-pr-conversations to resolve-pr-pendencies (776dfd055)
* 🏎️ ci: add core quality gate ratchet and split test:unit/test:integration (bbeaa333e)
* 🧪 test(web): format reset password test for improved readability (f1f89db80)
* 🧪 test(web): enhance reset password test to verify token in confirm request URL (53b25b912)
* 📚 docs: add prompt for resolving PR pendencies and CI/CD errors with GitHub CLI (41a45fba4)
* 🧪 test: use toBeInTheDocument for Radix Dialog portal elements in JSDOM (379e9011f)
* 📚 docs: move architecture and rules update from conclude-spec to implement-plan (a15e00246)
* 📶 rest: gate retry route on missing profile via VerifyUserAbsenceController (e372f4796)
* 📚 docs: add account confirmation spec, plan, and refine prompt templates (535d03ba5)
* 🧪 test: add Playwright integration suite for account confirmation flow (8dfd4f42e)
* 🖥️ ui: add stable test selectors and retryUserCreation stub for studio (00d84059c)
* ♻️ refactor: migrate retry user creation from RPC/Inngest to REST and remove web Inngest (858493201)
* 🧪 test: add unit and integration tests for retry user creation route (64cd62d02)
* 📶 rest: add POST /auth/sign-up/retry route with RetryUserCreationController (955fca4fb)
* 📑 interface: add retryUserCreation to AuthService interface (4a796b559)
* 📚 docs: expand conclude-spec-prompt with commit and pull request guidelines (8c5a5b9ef)
* ⚙️ config: ignore playwright test-results artifacts (928ab5851)
* 📚 docs: add reset password integration tests spec and plan (76f0ef83a)
* 🧪 test: add reset password integration suite and widget selector tests (c2947c914)
* 🖥️ ui: add stable selectors and dismissible success dialog to reset password flow (e8abf407b)
* 📚 docs: remove optional emoji suggestion from pull request description (457bba231)
* ⚙️ config: remove .gitpod.yml configuration file (48b78d8a1)
* 📚 docs: add test command to error detectors checklist (535ed5dad)
* ⚙️ config: restructure jest test projects and add integration test script (35e177858)
* ♻️ refactor: replace remaining code refs with initialCode in web layer (ba0cf7ebd)
* ♻️ refactor: replace remaining code ref with initialCode in challenges repository (4c9251d33)
* 🧪 test: fix domain test references from code to initialCode (a2f11626c)
* 🤖 ai: align creator instruction with initialCode field (d7687a66b)
* 🐛 fix: keep old migration referencing code column before rename (747f3e728)
* 🖥️ ui: rename code to initialCode in challenge widgets, mocks, and UI tests (187f917e2)
* ♻️ refactor: update DeleguaProvedorLsp for new addFunctionCall signature and add null safety (454fac2f0)
* 📮 validation: rename code to initialCode in challenge schemas (962c29497)
* 🌐 domain: rename code to initialCode in Challenge entity and add firstFunctionName to Code (73108aaaf)
* ⚙️ config: reset ServerMock in sign-in tests for improved isolation (fb13bb8f8)
* 🧪 test: update GetMdxBlocksGuideTool tests to reflect documentation changes and improve clarity (a1a443dbd)
* 🧪 test: reset ServerMock in sign-in tests for improved isolation (1d523e849)
* 🖥️ ui: polish assistant chatbot with close button and pagination fix (2b3d03af2)
* 🐛 fix: retry failed requests after auth session refresh (2f1055829)
* 🤖 ai: add GetLspGuidesTool for manual agent (9c261e804)
* 📶 rest: refactor FetchAllGuidesController to use GetGuidesUseCase (7ab182362)
* 🤖 ai: translate agent instructions from Portuguese to English (02302b76d)
* 🤖 ai: switch AI provider from OpenAI to OpenRouter (addf67478)
* 💾 db: replace Upstash cache with IORedis and add Redis config (b63fe4008)
* 📚 docs: add review spec prompt for finalizing technical specifications, including validation, documentation updates, and structured PR summaries (d31bf4017)
* 🐛 fix(server): add test mode handling in PostHogAnalyticsReportingProvider to return normalized report for test environments (6fbf70d4a)
* ⚙️ config: add moduleNameMapper entry for fakers in core package to enhance Jest configuration (153630d52)
* ♻️ refactor: update import paths for fakers in sign-in and sign-up test files to align with new directory structure (4c5eee880)
* 🏎️ ci: update CI workflow to use SERVER_ENV_TEST variable for test environment file creation (464333afb)
* 🏎️ ci: update CI workflow to create test environment file with SERVER_TEST_ENV variable (8fbecef31)
* ⚙️ config: add moduleNameMapper entry for fakers in core package to improve Jest configuration (f9268f020)
* 🏎️ ci: remove conditional check for SERVER_TEST_ENV in CI workflow for test environment file creation (d4c37340e)
* 📚 docs: update testing guidelines in conclude-spec-prompt to include new rules for route tests and clarify permitted test types (147e136e3)
* 🏎️ ci: refactor dependency installation steps in CI workflow for clarity and consistency (3a6fdb792)
* ⚙️ config: update package.json to include import and require paths for fakers in auth and global structures (98b25ac98)
* 🏎️ ci: enhance dependency installation in CI workflow with retry logic (a87acfdfb)
* 📚 docs: add SDD documentation and sign-in integration spec; delete outdated prd, plan, and prompts; update rules for shared ServerMock (55d47edcb)
* ⚙️ config: fix core package faker exports with proper types and default entries (9824270d7)
* ⚙️ config: simplify playwright integration scripts and pin workers to 1 (4489fc2dd)
* 🧪 test: add sign-in Playwright suite and refactor sign-up suite to use shared ServerMock factory (58c1a8bb6)
* 🖥️ ui: replace legacy useQueryStringParam with useSearchParams in sign-in page (321c748bc)
* 📶 rest: add query params support for sign-in route redirect (64add5803)
* ⚙️ config(web): update integration test scripts to include Playwright loader patching (169d3f71c)
* 🐛 fix: stabilize server mock registry temp storage (34a6381a6)
* 🏎️ ci: add integration tests workflow to CI pipeline for web app (674db6881)
* 📚 docs: remove obsolete implement-spec-prompt and update create-plan-prompt output section (390b85f77)
* 📚 docs: rewrite create-spec-prompt with streamlined structure and guardrails (39d70478b)
* 📚 docs: add web app integration testing documentation and rules (8b74ff623)
* 🖥️ ui: add test mode support with injectable RealtimeContext and ProfileChannel mock (0d527e316)
* ⚙️ config: add Playwright testing infrastructure with mock server routes (2433e3cd1)
* 🐛 fix: include environment information in PostHog registration for both server and web clients (a3ae57887)
* 🏎️ ci: add conditional check for SERVER_TEST_ENV before creating test environment file (12eba8af3)
* 🏎️ ci: update Supabase CLI version to 2.98.2 for improved functionality (91b7ce1f8)
* 📚 docs: update prompts for issue, PR, and PRD creation to reflect milestone usage and improve clarity (f8f15988f)
* 🏎️ ci: simplify database reset command and create test environment file (9d3c9cfdc)
* ⚙️ config: downgrade posthog-node to 5.17.2 for compatibility (8eac63e72)
* 📦 deps: update package-lock for posthog-js and posthog-node (5799251f3)
...
* 💾 db(server): add SQL grants for select permissions on public views for anon, authenticated, and service roles (ad76b04bb)
* 🚚 cd: change web app staging deployment trigger from pull request to push on main branch (c61b406f0)
* 📚 docs: add LSP layer documentation for Delegua language including structure and core functionalities (f85402d08)
* 🐛 fix(web): update condition for podium area rendering to use isTrue property (948f12e00)
* 🚚 cd: update deployment workflows for Server and Studio apps to trigger on push to main branch (2b1ecafff)
* 🚚 cd: rename Studio app deployment workflow and update environment file path in web app CI (cefc3fbb8)
* 🚚 cd: update Studio app deployment workflow to trigger on pull requests (c59a33d1e)
* 🚚 cd: update web app CI workflow to use .env.testing for environment variables (b95e3b159)
* 🚚 cd: add new GitHub Actions workflow for deploying Studio app to Coolify with Discord notifications (d334b6923)
* 🚚 cd: update web app deployment workflow to trigger on pull requests instead of releases (0da231a4f)
* 📚 docs: add infrastructure documentation for Stardust (6d1b91cb1)
* 📦 deps(studio): update motion and framer-motion to version 12.40.0 in package.json and package-lock.json (29876f87c)
* 📦 deps(studio): add @stardust/lsp version 0.1.0 to package.json and package-lock.json (7306a9186)
* ♻️ refactor(server): change imports to type-only for SessionDto and AccountDto in AuthFixture.ts (988215262)
* 📦 deps(studio): add @dnd-kit/sortable version 10.0.0 to package.json and package-lock.json (2adca1aae)
* 🚚 cd: change trigger from push to pull_request in server app deployment workflow (79b101777)
* 🐛 fix: remove debug log and enable broker.publish for AccountSignedInEvent (b86b2b79a)
* 🚚 cd: migrate CI/CD from Heroku to Coolify and simplify pipelines (7323034dd)
* 🐳 docker: remove postgresql15-client installation from server Dockerfile (f88e38a0e)
* 🚚 cd: update deployment workflow from Heroku to Coolify (a8573a00e)
* ♻️ refactor(web): simplify lexador mapping by removing hardcoded code block (900a41744)
* 📦 deps: bump @designliquido/delegua to 1.24.2 (51cf221de)
* 📚 docs: update DeleguaLsp references to DeleguaProvedorLsp (6e7ed7a67)
* ♻️ refactor: rename DeleguaLsp to DeleguaProvedorLsp (7f329a317)
* 🚚 cd: migrate deployment from Heroku to Coolify (9de6d8be9)
* 📚 docs: update documentation for audio removal feature (c99d75de8)
* ♻️ refactor: use type-only import for Text in OpenAITtsProvider (2c214addd)
* 🖥️ ui: add remove audio button to studio editor (b11a13fec)
* 📟 rpc: add remove text block audio file queue job (86011d6a9)
* 💾 db: add clear_text_block_audio rpc and update types (b22410230)
* 📶 rest: add remove text block audio endpoint and validation (321966c1e)
* 🌐 domain: add remove audio feature to text block domain (337d3b99c)
...
* ⚙️ config: replace hardcoded auth credentials with environment variables in REST client (e0aed987e)
* 🧪 test: extend SupabaseFixture to clear additional tables before tests (326c41dca)
* ⚙️ config: hardcode auth credentials in REST client (fca515c15)
* 🧪 test: add feedback screenshot validation and dialog upload tests (8336ccc65)
* ♻️ refactor: extract screenshot filter and handle broken images in FeedbackDialog (f1d7b7264)
* 🌐 domain: add debug logging to SendFeedbackReportUseCase (1b778a4d8)
* ♻️ refactor: use authorAggregateSchema in NotificationFunctions (ab49a7dbe)
* 📮 validation: add slugSchema and authorAggregateSchema (17ed1fbd2)
* 📚 docs: fix typo in migration spec filename, close feedback spec, update architecture (c88193abb)
* 🧪 test: refactor TestLockFixture to use a constant for locks directory and ensure directory creation (12a1412e2)
* 💾 db: add Supabase config and migrations for notes, text block audio, and storage (c86de405d)
* 🧪 test: add integration tests for text block audio generation, storage controllers, and profile notes (d5fcf9667)
* 🧪 test: add LocalSupabaseProxy for managing Docker-based Supabase proxy in tests (05c7bc43c)
* 🧪 test: update validation error messages from '3 letras' to '3 caracteres' across route tests (499f4fb4c)
* 🧪 test: update fixtures with image fields, remove slug, and add LocalSupabaseProxy (a50ce6cb6)
* 📚 docs: reorganize feedback specs and update implementation plan (3586ad09a)
* 🖥️ ui: upload screenshots directly with signed storage provider (2c6811f5a)
* 🧰 provision: add web signed file storage provider (2bd750f63)
* 📶 rest: migrate clients to signed upload URL workflow (c0c2b4cb5)
* 📶 rest: remove multipart upload route and enforce signed URL access (649275679)
* 🏷️ type: remove legacy uploadFile from storage service contract (16c7b99e4)
* ♻️ refactor(server): remove slug from rocket mapping and database schema, add is_purchasable field (77efc8169)
* 🐛 fix(web): ensure query parameters are cleared after removing a file in StorageService (515db2f25)
* ⚙️ config: update AGENTS.md with error detectors and update rest client samples (cc5d441ad)
* 📚 docs: document signed upload architecture, plan, and conclude spec (4f5ef103f)
* 📶 rest: align web storage service with signed upload contract (a9e0ffb99)
* 🖥️ ui: wire ProvisionContext and migrate ImageInput and PictureInput to signed upload (da9510f8e)
* ♻️ refactor: fix db mappers null safety, add rocket slug, harden test proxy (2d9c030a8)
* 🧰 prov: implement createSignedUploadUrl across server and studio providers (d91bea15b)
* 🌐 domain: add signed upload URL value object, error, use case, interfaces, and validation schema (22476df95)
* docs: add code review step (1.6) to conclude-spec-prompt (8e0dd91cf)
* 🐛 fix(server): introduce constants for lesson event names and update imports in related files (833eff3ae)
* 📦 deps(server): update Supabase commands to specify working directory for database operations (6527d5691)
* ⚙️ config(server): enhance Jest configuration for server and route tests with project-specific settings (b10443e5c)
* ♻️ refactor: remove console log from SendFeedbackReportUseCase execution (be1074e3e)
* 📚 docs: update implementation plan prompt to clarify objectives and structure (ce60f1272)
* 🧪 test: remove obsolete feedback and planet route integration tests (1a55d66cd)
* 🧪 test: add server route integration coverage (2fd926c46)
* 💾 db: add insignia schema and supabase fallbacks (8993af47b)
* 📚 docs: define server route testing guidance (071f0d5e9)
* 📑 interface: export forum entity fakers (e7625360f)

## 1.7.0 (2026-05-22)

* 🖥️ ui: restore idle audio controls and batch storage checks (1fb4ce8b1)
* 🧪 test: enhance FetchImagesListController tests with folder parameter in query (df5266522)
* 📚 docs: update lesson story audio control spec (4e3a51f0b)
* 🧪 test: update lesson story audio batch props (598c5ddbd)
* 🖥️ ui: add batch cancel and storage-aware audio controls (a52ecd5db)
* 📮 validation: add story audio folder to storage schema (44743a3e7)
* 🖥️ ui: enhance TextBlockCard styling for audio generation state (dada555b1)
* 📚 docs: update text block audio planning and ui rules (418acbd90)
* 🧪 test: cover audio payload propagation and story view props (ded631e97)
* 🖥️ ui: add text block audio controls and polling in lesson story (0f5a06d7d)
* 🧰 prov: delete previous block audio during regeneration (3b560c011)
* 📶 rest: expose lesson audio voices and query-based file listing (949766fc7)
* 📶 rest: support typed delete payloads in lesson audio flows (364fa1c70)
* ✨ use case: include current audio filename in generation events (03864fbfb)
* 📮 validation: add text block audio schema support (172d585fa)
* 📑 interface: extend lesson and rest client audio contracts (812069c32)
* ♻️ refactor: resolve text block audio review threads (348609ad0)
* ♻️ refactor: update BackupDatabaseJob to use FileStorageProvider interface (5179c135e)
* ⚙️ config: update dependencies, changelog and adjust storage use case signatures (b7f88a08e)
* 📚 docs: update architecture, PRD, plan and rules for text block audio generation (fae93d5e5)
* 💾 db: add update_text_block_audio function for partial JSONB audio persistence (d4aad3257)
* 📶 rest: add text block audio endpoints and update storage controllers (6064cf1aa)
* 🎞️ queue: add lesson audio jobs and co-locate Inngest event validation (d005e9799)
* 🧰 prov: add TTS providers and refactor storage provider naming (71ff1fdac)
* 📮 validation: add audio voice and request text block audio generation schemas (1f1fa4436)
* ✨ use case: add text block audio generation and cancellation flows with tests (b9d4c2f68)
* 🌐 domain: add text block audio structures, errors, events and tests (a96225d65)
* 🐛 fix: map auth session missing to 401 and stabilize parallel tests (79d6520ab)
* ♻️ refactor(server): reorder imports in HonoApp.ts for improved organization (6b2ab8374)
* 📦 deps(lsp): update @designliquido/delegua dependency to version 1.23.1 in package-lock.json and package.json (30f5c809e)
* 🚚 cd: remove Vercel CD workflows for production and staging (0ecc7e546)
* ♻️ refactor: format folder path guard for multiline readability (7e3d80e93)
* 🧪 test: align storage controller assertions with canonical folder paths (96c57bc79)
* 🖥️ ui: remove debug logs and normalize storage image folders (dcefcc91c)
* 🐛 fix: restore supabase storage bucket name (fc37305be)
* 🐛 fix: enforce folder path validation and legacy path normalization (eb62a100f)
* 📚 docs: update storage naming in changelog and feature specs (dfa52bce5)
* 🖥️ ui: migrate storage folder usages to file storage folder paths (1ea962ece)
* 📶 rest: align storage routes and services with file folder paths (03434a30e)
* 🧰 prov: update supabase provider folder path handling (a82342767)
* ♻️ refactor: rename storage folder path contracts across core (b95164174)
* 🐛 fix: use folder.value in storage providers and tests (807838c09)
* 📚 docs: update storage folder paths in specs documentation (d62ea3262)
* 🖥️ ui: replace useStorageImage with useFileStorage hook in studio (723270b87)
* 📶 rest: update storage services to use folder.value instead of folder.name (dc219d7f1)
* 🧪 test: update storage controller tests for new folder path interface (2943dba59)
* 🌐 domain: migrate TextBlock to lesson domain and add audio support (1eadcca24)
* 🌐 domain: refactor storage folder and provider to support namespaced paths (272cc3f45)
* 🐛 fix: split challenges loading states and restore test mocks (ff226f68e)

## 1.6.0 (2026-05-14)

* 🚚 cd: serialize production migrations and remove notes test migrations (d15cd38aa)
* 📚 docs: update conclude-spec-prompt and implement-plan-prompt with new completeness checks and divergence classification (216f3ec96)
* docs: improve conclude-spec with plan.md verification and structured reviewer checklist (5daea398c)
* docs: add orchestrator review gate after each subagent phase (e96c4e47b)
* 💾 db: remove unused next star and delete user routines (fc8214783)
* 🧪 test: remove rocket slug from profile fixture (ee3616b6c)
* ⚙️ config: add server database test reset script (20f410b8e)
* 💾 db: sync Supabase baseline and notes migrations (07e58b0c9)
* 📚 docs: document server Supabase CLI workflow (d36ad6144)
* 🚚 cd: run server database migrations before deploy (2543d5ba9)
* ⚙️ config: align server Supabase CLI workspace paths (33d9ea401)
* ⚙️ config: refactor install-skills script to use an array for skill additions (14ac25da0)
* 📚 docs: update notes specs for interactive code block node (074945712)
* 🐛 fix: render interactive code blocks reliably in notes editor (19f6ed797)
* 📚 docs: close notes page spec and update product documentation (549dec113)
* 📮 validation: allow empty note content up to max length (ca794e803)
* 🧪 test: cover empty note content in profile notes controllers (d0e634a61)
* 🖥️ ui: add dedicated notes page and sidebar navigation flow (a315ddf69)
* docs: add PRD for text block automatic audio generation feature (056805cd7)
* ♻️ refactor: update NotesDrawer component to use ReactElement type and improve search handling (b95eb21fd)
* 🧪 test: fix notes drawer save error scenario assertion (d7212ca58)
* 📚 docs: update specs, prompts, rules, and notes PRD (79b7add90)
* 🎨 design: update stardust design document (97ffcd89f)
* 🧪 test: update studio and web widget test expectations (5029e8630)
* 🐛 fix: align delegua regex constant naming (ed2c0da44)
* 🤖 ai: adjust lesson toolkit behavior and wording (d2fdff10d)
* 📦 deps: add tiptap dependencies for notes editor (1d82451c3)
* 🧪 test: add core tests for note entity and use cases (0238a76df)
* 🖥️ ui: add notes drawer widget to lesson and challenge flows (6d2377e2a)
* 📶 rest: add profile notes service methods for web and studio (8ee3fed7a)
* 📮 validation: simplify global schemas and add note schema (0a27589c6)
* 📶 rest: expose authenticated profile notes CRUD routes (e713a158f)
* 💾 db: add notes table and supabase persistence mapping (63d772c78)
* 🌐 domain: add profile notes domain model and use cases (a22edcaf0)
* 🏎️ ci: update Heroku workflow to reset local database and set working directory for Supabase (95f37dc7f)
* 🐛 fix: improve error handling and data type assertions in SupabaseUsersRepository (b0bf9582f)
* 🧪 test: add profile achievement route integration coverage (9621626ca)
* 💾 db: add bulk profile test persistence support (84469bcd3)
* ♻️ refactor: expose server app hooks for route integration tests (70c9f1f23)
* ⚙️ config: enable server integration test tooling (79c4087b4)
