...
export const texts: Text[] = [
  ...
  },
  {
    type: "default",
    content:
      "Espera, há tubarão vindo em nossa direção, e ele parece ser bem grande!",
  ...
  },
  {
    type: "image",
    content:
      "Vou gerar um número aleatório por meio de uma função nativa.",
    picture: "tubarao-malvado.jpg",
  },
  {
    type: "user",
...
// Resultado: Um número aleatório entre 1 e 8`,
  ...
  },
  {
    type: "user",
    content:
      "Não era para ser um número aleatório entre 1 e 9?",
  },
  {
    type: "default",
    content:
...
escreva(numero)`,
  ...
  },
  {
    type: "default",
    content:
      "Se o máximo é *10* e o mínimo é *9*, então o resultado só pode ser *9*.",
    picture: "panda.jpg",
  },
  {
    type: "code",
...
// Resultado: 9`,
  ...
  {
    type: "image",
    content: "E eu já armei uma função para vocês escreverem a resposta no *retorna* dela",
    picture: "tubarao-malvado.jpg",
  },
  {
    type: "user",
