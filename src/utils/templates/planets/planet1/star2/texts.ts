export const texts = [
  ...
  {
    content:
      'Por exemplo, para fazer com que o foguete imprima no painel: "explorar o espaço é legal", basta usar o comando chamado `escreva()`, colocando a mensagem entre seus parênteses.',
    type: 'default',
    picture: 'panda-dando-risadinha.jpg',
  },
  {
