...
var simbolos = '$@%&'`,
  ...
  {
    content:
      'Cuidado, o `250` no exemplo acima não do tipo número, mas sim do tipo texto, justavemente porque ele está entre aspas.',
    type: 'alert',
    picture: 'panda-andando-com-bambu.jpg',
  },
  {
...
// Resultado: Eu encontrei um planeta e ele se chama Datahon`,
  ...
  {
    content:
      'Cuidado também: se você usar aspas duplas dentro de outras aspas duplas, não vai dar muito certo.',
    type: 'alert',
    picture: 'panda-andando-com-bambu.jpg',
  },
  {
