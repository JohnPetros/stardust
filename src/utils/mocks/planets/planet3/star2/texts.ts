export const texts = [
  ...
  },
  {
    type: 'default',
    content:
      'Por exemplo, é importante averiguar se a quantidade de combustível atualmente disponível é maior que a quantidade necessaária para fazer decolagem.',
    picture: 'panda-deslumbrado.jpg',
  },
  {
    type: 'user',
...
//  Resultado: falso`,
  ...
  },
  {
    ...
    content:
      'É aí que entra em cena o novo operador que verifca se um valor é igual ou maior que outro valor, e por isso o motivo usamos o símbolo `>=`.',
    picture: 'panda-deslumbrado.jpg',
  },
  {
    type: 'code',
...
//  Resultado: verdadeiro`,
  ...
  },
  {
    type: 'default',
    content:
      'Perceba que o resultado é mesmo que usar o `>=`, pois ambos os operadores checam se é `verdadeiro` uma de duas condições (se é maior/menor ou igual).',
    picture: 'panda-deslumbrado.jpg',
  },
  {
    type: 'default',
  ...
  },
  {
    type: 'default',
    content:
      'Por exemplo, lembra que eu disse que os dois motores do foguete precisam usar a mesma quantidade de energia?',
    picture: 'panda-deslumbrado.jpg',
  },
  {
    type: 'user',
