...
import { ChatInputSelections } from './ChatInputSelections'
...
export const ChatInputView = ({
  ...
  const { textareaRef, message, handleMessageChange, handleKeyDown, handleSendMessage } =
    useChatInput({ assistantSelections, onSendMessage })
  ...
  return (
    ...
    >
      <ChatInputSelections
        ...
        onRemoveTextSelection={onRemoveTextSelection}
        onRemoveCodeSelection={onRemoveCodeSelection}
      />
