...
export const RocketAnimationView = ({ animationRef, isVisible }: Props) => {
  return (
    <motion.div
      variants={rocketVariants}
      initial='hidden'
      animate={isVisible ? 'visible' : ''}
      className='pointer-events-none fixed left-1/2 top-1/2 z-[60] -translate-x-1/2 -translate-y-1/2 overflow-hidden'
      aria-live='polite'
