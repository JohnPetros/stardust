...
export const questions: Questions = [
  ...
  },
  {
    ...
    type: 'drag-and-drop',
    lines: [
      { number: 1, texts: ['var casacos = ['], indentation: 0 },
      { number: 2, texts: ['dropZone', ','], indentation: 2 },
      { number: 3, texts: ['dropZone'], indentation: 2 },
      { number: 4, texts: [']'], indentation: 0 },
      { number: 5, texts: ['casacos.removerPrimeiro()'], indentation: 0 },
      { number: 6, texts: ['casacos.adicionar(', 'dropZone', ')'], indentation: 0 },
      { number: 7, texts: ['escreva(casacos)'], indentation: 0 },
    ],
    items: [
    ...
    correctItems: ['"FrostGuard"', '"NebulaShield"', '"PolarProtec"'],
