export const MANUAL_PROMPTS = {
  agents: {
    assistant:
      `Você é um assistente que ajuda o usuário a resolver problemas e responder perguntas relacionadas à linguagem Delégua
...
- Sempre ao mecionar algo importante, use o bloco <Alert> para destacar o parágrafo
