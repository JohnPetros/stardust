...
// Hook para gerenciar o estado do AlertDialog
function useAlertDialog(initialOpen = false) {
...
// Interface para a ref do AlertDialog
...
// Componente AlertDialog com suporte a ref
...
>(({ defaultOpen = false, children, ...props }, ref) => {
  const { open, setOpen, openDialog, closeDialog, toggleDialog } =
    useAlertDialog(defaultOpen)
