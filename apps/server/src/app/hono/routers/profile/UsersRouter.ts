    ...
    this.router.get(
      ...
      this.validationMiddleware.validate(
        ...
        z.object({
          ...
          levelOrder: listingOrderSchema,
          weeklyXpOrder: listingOrderSchema,
          unlockedStarCountOrder: listingOrderSchema,
          unlockedAchievementCountOrder: listingOrderSchema,
          completedChallengeCountOrder: listingOrderSchema,
