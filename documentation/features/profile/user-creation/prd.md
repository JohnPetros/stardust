---
title: Criação de Usuário no Perfil
status: draft
source:
  - type: direct-request
    ref: documentation/features/profile/user-creation/prd.md
...
| --- | --- | --- |
| S1 | documentation/features/profile/user-creation/prd.md | Fonte legada de produto; autoridade canônica no Confluence não identificada. |
