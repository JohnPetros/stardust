...
source:
  - type: direct-request
    ref: documentation/features/playground/prd.md
...
| --- | --- | --- |
| S1 | documentation/features/playground/prd.md | Fonte legada de produto; autoridade canônica no Confluence não identificada. |
...
| --- | --- |
| Escopo | Galeria publica ou exemplos definidos para usuarios nao autenticados fora do fluxo autenticado do playground. |
...
| Escopo | Persistencia automatica ao aplicar exemplos. |
