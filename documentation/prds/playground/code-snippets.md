...
- **Snippets de exemplo:** O editor deve disponibilizar um catalogo inicial de snippets de exemplo para acelerar o primeiro uso e a experimentacao.
- **Catalogo inicial:** A primeira versao do catalogo deve conter exatamente estes 10 snippets: `Ola mundo`, `Variaveis e tipos`, `Condicional se/senao`, `Laco para`, `Laco enquanto`, `Funcao com retorno`, `Lista e repeticao`, `Dicionario e acesso por chave`, `Entrada do usuario` e `Mini algoritmo: numero par`.
- **Abertura manual do catalogo:** O catalogo de snippets de exemplo nao deve abrir automaticamente por padrao; o usuario deve aciona-lo manualmente a partir do editor.
- **Aplicacao local do exemplo:** Ao selecionar um snippet de exemplo, o sistema deve preencher o editor localmente sem persistir automaticamente o conteudo.
...
3. O usuario pode selecionar um snippet de exemplo ou preencher titulo e codigo manualmente no editor.
