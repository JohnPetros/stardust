...
source:
  - type: issue
    ref: https://github.com/JohnPetros/stardust/milestone/30
...
| --- | --- | --- |
| S1 | https://github.com/JohnPetros/stardust/milestone/30 | Fonte legada de produto; autoridade canônica no Confluence não identificada. |
...
#### RP-05 — Acesso Global pelo Layout

Necessidades do usuário:

- 🚧 Em construção — necessidade não explicitada no documento legado.

Resultado: Acesso Global pelo Layout.
...
#### RP-06 — Página Dedicada de Notas (`/notes`)

Necessidades do usuário:

- 🚧 Em construção — necessidade não explicitada no documento legado.

Resultado: Página Dedicada de Notas (`/notes`).
...
| --- | --- |
| Escopo | Compartilhamento de notas entre usuários. |
| Escopo | Histórico de versões ou desfazer edições. |
| Escopo | Busca ou filtro de notas por texto. |
| Escopo | Organização de notas em pastas, tags ou categorias. |
| Escopo | Vinculação de uma nota a uma estrela, desafio ou questão específica. |
| Escopo | Exportação de notas (PDF, Markdown, etc.). |
| Escopo | Notas para usuários não autenticados (rascunho local). |
| Escopo | Limite de tamanho do corpo da nota nesta versão. |
| Escopo | Acesso administrativo às notas dos usuários no Studio. |
